        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="image" accept="image/*" class="form-input" data-crop="true" data-crop-ratio="1920/700" data-preview-img="imgPreview" data-preview-box="imgPreviewBox" required>
